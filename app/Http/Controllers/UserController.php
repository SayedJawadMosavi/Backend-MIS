    ...
    public function store(Request $request)
    {
        try {
            $request->validate(
                ...
                [
                    'email.unique' => 'ایمل قبلا استفاده شده!',
                    'role.required' => 'نقش ضرور می باشد',
                    'permissions.required' => 'صلاحیت ضرور می باشد',
                    'email.required' => "ایمیل ضروری می باشد",
                    'email.unique' => "ایمیل ذیل موجود می باشد",
                    'email.email' => "ایمیل ذیل درست نمی باشد",
                    'password.required' => 'رمز عبور ضرور می باشد',
                    'confirm_password.required' => 'تایید رمز عبور ضرور می باشد',
                    'password.min' => 'رمز عبور کمتر از یک بوده نمی تواند',
                    'confirm_password.min' => 'تایید رمز عبور کمتر از یک بوده نمی تواند',
    ...
    public function editUser(Request $request)
    {
        $request->validate(
            ...
            [
                'email.unique' => 'ایمل قبلا استفاده شده!',
                'role.required' => 'نقش ضرور می باشد',
                'permissions.required' => 'صلاحیت  ضروری می باشد',
                'email.required' => "ایمیل ضروری می باشد",
                'email.unique' => "ایمیل ذیل موجود می باشد",
            ]
        );
